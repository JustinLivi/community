(function (factory) {
    ...
    var CNode = /** @class */ (function () {
        function CNode(width, height) {
            this.optimal = math_1.random(height / 20, height / 10);
            this.theta = math_1.random(360);
            this.loc = {
                x: width / 2 + math_1.random(height / 20, height / 10),
                y: height / 2 + math_1.random(height / 20, height / 10)
            };
            this.vel = {
                x: 0,
                y: 0
