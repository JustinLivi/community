(function (factory) {
    ...
    var CommunitySketch = /** @class */ (function () {
        function CommunitySketch(canvas) {
            this.nodes = [];
            ...
            this.nodecount = 100;
            this.resetNodes();
            this.animator = new Animator_1.Animator({ draw: this.draw, maxFrames: 500 });
            this.animator.start();
        }
        CommunitySketch.prototype.reset = function () {
            this.resetNodes();
            this.artBox.clear();
            this.animator.reset();
            this.animator.start();
        };
        CommunitySketch.prototype.resetNodes = function () {
            for (var count = 0; count < this.nodecount; count += 1) {
                this.nodes[count] = new CNode_1.CNode(this.width, this.height);
            }
        };
        CommunitySketch.prototype.findFarthest = function (nodeId, targetNode) {
            var farthest;
        ...
        CommunitySketch.prototype.findClosest = function (nodeId, targetNode) {
            var closest;
            var closestDistance;
            var _a = targetNode.loc, x1 = _a.x, y1 = _a.y, optimal = targetNode.optimal;
            for (var count = 0; count < this.nodecount; count += 1) {
        ...
        CommunitySketch.prototype.optimizeDistance = function (targetNode, comparator) {
        ...
        CommunitySketch.prototype.draw = function () {
    ...
    exports.CommunitySketch = CommunitySketch;
});
